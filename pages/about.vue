<template>
  <v-container fluid>
    ...
    <v-card flat tile class="ma-6" v-show="breakpoint.lg">
        ...
        <v-row justify="center" align="center" class="">
          <v-col cols="8" class="anim fade-in-left hidden">
            <v-card-text class="text-h5 text-grey-dark font-weight-light">
              ...
              <v-list tile  color="blue-grey darken-4" class="my-10 pa-10 anim fade-in-left hidden">
                <v-list-item>
      ...
      <v-card flat tile class="mt-2 mb-8 pa-0">
        <v-row justify="center" align="center" class="">
          <v-col cols="4" order="last" class="mx-2 anim fade-in-left hidden">
        ...
        <v-row justify="center" align="center">
          <v-col cols="3" class="mx-2 anim fade-in-up fade-in-up hidden">
            <Member name="Oliver Carvajal" :role="['Founder','Client Operations']" size="196" shape="50" type="team"/>
          </v-col>
          <v-col cols="3" class="mx-2 anim fade-in-up hidden">
    ...
    <v-card flat tile class="ma-6" v-show="breakpoint.md">
      ...
      <v-card flat tile class="mt-2 mb-8 pa-0">
        <v-row justify="center" align="center" class="">
          <v-col cols="6" order="last" class="mx-2 anim fade-in-left hidden">
            <v-card-title class="overline text-h3 text-orange-dark">
            <span class="font-bot">Core Team</span>
          </v-card-title>
          </v-col>
    ...
    <v-card flat tile class="ma-6" v-show="breakpoint.sm">
      ...
      <!-- header: network of collective minds-->
        <v-row justify="center" align="center" class="">
          <v-col cols="12" order="first" class="mx-2 anim fade-in-left hidden">
      ...
      <v-card flat tile class="mt-2 mb-8 pa-0">
        <v-row justify="center" align="center" class="">
          <v-col cols="12" order="last" class="mx-2 anim fade-in-left hidden">
            <v-card-title class="overline text-h4 text-orange-dark">
            <span class="font-bot">Core Team</span>
          </v-card-title>
          </v-col>
